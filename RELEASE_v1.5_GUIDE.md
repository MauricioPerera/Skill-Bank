# 🚀 Creating Release v1.5 on GitHub

## Step-by-Step Instructions

### 1. Go to Releases Page

Navigate to: https://github.com/MauricioPerera/Skill-Bank/releases/new
...
- Click "Choose a tag"
- Type: `v1.5.0`
- Click "Create new tag: v1.5.0 on publish"

#### **Release title**
```
Skill Bank v1.5 - Memory & Learning
```
...
1. **Verify the release:** https://github.com/MauricioPerera/Skill-Bank/releases/tag/v1.5.0

2. **Share the release:**
   - Copy the release URL
   - Use templates from `ANNOUNCEMENT.md`
   - Post on LinkedIn, Twitter, etc.

3. **Update your local tags:**
   ```bash
   git fetch --tags
   git tag -l  # Should show v1.5.0
   ```
...
- ✅ Ready for social media announcements
- ✅ Clear changelog and migration guide

**Next:** Share on social media using templates from `ANNOUNCEMENT.md`!
